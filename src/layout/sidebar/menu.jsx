...
export const MENUITEMS = [
    {
        ...
        Items: [
            ...
            //     ]
            // },
            { path: `${process.env.PUBLIC_URL}/dashboard/default`, icon: Home, title: 'IND-NLD Slots', type: 'link' },
            { path: `${process.env.PUBLIC_URL}/dashboard/marprt`, icon: Home, title: 'Mar-Prt Slots', type: 'link' },
        ]
